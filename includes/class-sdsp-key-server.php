...
final class SDSP_Key_Server
{
    ...
    {
        add_action('wp_ajax_sdsp_key', [$this, 'serve_key']);
        add_action('wp_ajax_nopriv_sdsp_key', [$this, 'serve_key']);
    }
    ...
    public function serve_key(): void
    {
         ...
         */
        $canView = apply_filters('sdsp_can_view_video', is_user_logged_in(), $postId, get_current_user_id());
        ...
        $encrypted = get_post_meta($postId, SDSP_Post_Type::META_ENCRYPTED_KEY, true);
        ...
        $rawKeyBase64 = SDSP_Crypto::decrypt($encrypted);
